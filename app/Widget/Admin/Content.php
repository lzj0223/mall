...
class Content extends AbstractBase
{
    ...
    public function edit($data)
    {
        ...
        $html = $this->hasPermission ?
                    '<a class="layer-iframe" href="'.$url.'"><i class="fa fa-pencil"></i></a>'
    ...
    public function position()
    {
        ...
        $html = $this->hasPermission ?
                    '<div class="btn-group btn-group-sm" style="float:left;margin:10px 0;margin-right:10px;"><a class="btn btn-primary pl-position"><i class="fa fa-exchange"></i>关联推荐位</a></div>'
                        : '';
        return $html;
    }
