...
class Position extends AbstractBase
{
    ...
    public function edit($data)
    {
        ...
        $html = $this->hasPermission ?
                    '<a class="ajaxModal" data-toggle="modal" data-target="#ajaxModal" href="'.$url.'"><i class="fa fa-pencil"></i></a>'
    ...
    public function relation($data)
    {
        ...
        $html = $this->hasPermission ?
                    '<a class="layer-iframe" title="关联的文章" href="'.$url.'"><i class="fa fa-list"></i></a>'
    ...
    public function deleteRelation($data)
    {
        ...
        $html = $this->hasPermission ?
            '<a href="' . $url . '" class="ajax-delect" data-tips="确定取消吗?" title="取消关联"><i class="fa fa-trash-o"></i></a>'
            : '<i class="fa fa-trash-o" style="color:#ccc"></i>';
        return $html;
    }
