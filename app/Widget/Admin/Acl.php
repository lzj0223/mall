...
class Acl extends AbstractBase
{
    ...
    public function delete($data)
    {
        ...
        $url = R('common', $this->module.'.'.$this->class.'.'.$this->function, ['id' => url_param_encode($data['id'])]);
        $html = $this->hasPermission ?
            '<a href="' . $url . '" class="ajax-delect" data-tips="确定删除吗?"><i class="fa fa-trash-o"></i></a>'
    ...
    public function sort()
    {
        ...
        $html = $this->hasPermission ?
                    '<div class="btn-group" style="float:left;margin:10px 0;margin-right:20px;"><button class="btn btn-primary btn-sm sys-btn-submit" type="submit" data-loading="处理中..." ><i class="fa fa-sort"></i> <span class="sys-btn-submit-str">排序</span></button></div>'
                        : '';
        return $html;
    }
